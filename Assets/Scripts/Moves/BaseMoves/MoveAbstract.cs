...
public abstract class MoveBehaviour : MonoBehaviour
{
    ...
    public Combatant combatantToAct;
    ...
    public virtual void LoadMoveReferences(Combatant combatantToAct, CombatManager combatManager)
    {
        ...
        if (combatantToAct.targetCombatant == null)
        {
    ...
    public virtual void CheckForBackStabBonus()
    {
        if (combatantToAct.CombatLookDirX == combatantToAct.targetCombatant.CombatLookDirX)
        {
            combatantToAct.AttackTotal = Mathf.RoundToInt(combatantToAct.AttackTotal * 1.5f);
            combatantToAct.targetCombatant.isBackstabbed = true;
        }
    }
    ...
    public virtual IEnumerator ApplyMoveToEnemy()
    {
        ...
        yield return combatantToAct.targetCombatant.currentMoveBehaviour.OnReceieveAttack(combatantToAct, combatantToAct.targetCombatant);
    ...
    {
        yield return combatantToAct.targetCombatant.combatantUI.fendScript.ApplyAttackToCombatant(combatantToAct, combatantToAct.targetCombatant);
    }
    ...
    public virtual IEnumerator ReturnTargetToFightingPos()
    {
        ...
        else //return target to original pos if still alive
        {
            ...
            if (combatantToAct.targetCombatant.isBackstabbed)
            {
