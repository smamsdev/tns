...

    {
       ...
       // var enemyPosition = combatManager.battleScheme.enemies[combatManager.selectedEnemy].transform.position;
...

        {
          ...
          //combatManager.enemies[combatManager.selectedEnemy].combatantUI.fendScript.UpdateFendText(combatManager.playerCombat.attackPower, playerMovementScript.lookDirection, moveSelected.attackPushStrength);
          //
