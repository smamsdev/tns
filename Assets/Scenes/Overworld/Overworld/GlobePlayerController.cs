...
public class GlobePlayerControllerBillboard : MonoBehaviour
{
    [Header("References")]
    ...
    void UpdateBillboard()
    {
        ...
        // 2️⃣ Distance-based sorting (match towns)
        float dist = Vector3.Distance(playerCamera.position, transform.position);
        spriteRenderer.sortingOrder = Mathf.RoundToInt(-dist * 1000f); // negative: closer = higher
    }
